...
# from scipy import signalasd
from LineIterator2 import get_line_cor
import rospkg
rospack = rospkg.RosPack()
cur_dir = rospack.get_path(u'beginner_tutorials')
...
def get_steer(img_rgb, mask):
    ...
    if sign != -1:
        print u"Co bien bao! " + unicode(sign)
        sign = sign[0][0]
