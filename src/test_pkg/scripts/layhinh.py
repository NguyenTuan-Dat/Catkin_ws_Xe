...
check = True
check2 = True  
PATH = '/home/ubuntu/data/RGB'
PATH2 = '/home/ubuntu/data/DEPTH'
...
def listener():
	...
	rospy.Subscriber('/camera/rgb/image_raw/compressed', CompressedImage, callback2)
